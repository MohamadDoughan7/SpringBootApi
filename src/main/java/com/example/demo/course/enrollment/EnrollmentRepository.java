...
public interface EnrollmentRepository {
   ...
   */
  EnrollmentEntity findByIds(Long studentId, Long courseId);

  /**
   * Defining the insertEnrollment method.
   *
   * @param enrollmentEntity to be added to the database.
   */
  ...
  /**
   * This method is for checking if the enrollment with the entered ids is available in the
   * database.
   *
